...
class ArticleService {
  ...
  Future<ArticlePagination> getArticles(String categoryName, Map<String, dynamic> searchCriteria) async {
    ...
    final FieldPagination fieldPagination = await apiProvider.articleApi.getAllCategories(<String, String>{
      'name': categoryName
    });
    ...
    final Map<String, dynamic> queryParams = <String, dynamic>{
      'category': fieldPagination.items[0].id
//      'category': _getCategoryIdByName(categoryName)
    };
